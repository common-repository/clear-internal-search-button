...
function cisb_admin_enqueue_scripts() {
    wp_enqueue_script('clear-internal-search-button-js', plugin_dir_url(__FILE__) . 'clear-internal-search-button.js', array('jquery'), '1.8', true);
    wp_enqueue_style('clear-internal-search-button-css', plugin_dir_url(__FILE__) . 'styles.css', array(), '1.8');
}
